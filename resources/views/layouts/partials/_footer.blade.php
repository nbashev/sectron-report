...
<script src="{{ URL::asset('js/bootstrap-datepicker3/bootstrap-datepicker.min.js')}}"></script>
<script src="{{ URL::asset('js/bootstrap-datepicker3/bootstrap-datepicker.mk.min.js')}}"></script>
